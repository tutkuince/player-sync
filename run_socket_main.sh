...
mvn clean package -P player-communication

# Step 2: Start the PlayerServer in the background
echo "Starting PlayerServer..."
java -cp target/player-communication.jar com.incetutku.socket.server.PlayerServer &
...
java -cp target/player-communication.jar com.incetutku.socket.client.PlayerClient
